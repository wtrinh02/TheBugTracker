...
namespace TheBugTracker.Areas.Identity.Pages.Account
{
    public class RegisterByInviteModel : PageModel
    {
        ...
        {
            Invite invite = await _btInviteService.GetInviteAsync(token, email, companyId);
            ViewData["Email"] = invite.InviteeEmail;
            ViewData["FirstName"] = invite.InviteeFirstName;
            ViewData["LastName"] = invite.InviteeLastName;
            ViewData["CompanyId"] = invite.CompanyId;
            ViewData["Token"] = invite.CompanyToken;
        ...
        public async Task<IActionResult> OnPostAsync(string returnUrl = null)
        {
            ...
            if (ModelState.IsValid)
            {
                ...
                await _btInviteService.AcceptInviteAsync(Input.token, user.Id, Input.CompanyId);
